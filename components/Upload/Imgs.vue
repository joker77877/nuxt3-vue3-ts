<template>
  <div class="upload-box">
    ...
    <el-image-viewer v-if="imgViewVisible" :url-list="[viewImageUrl]" @close="imgViewVisible = false"></el-image-viewer>
  </div>
</template>
